<template>
    <div>
        <form 
            ...
            method="POST"
        >
                    <input v-model="departure_address" placeholder="Введите значение">
                    <input v-model="destination_address" placeholder="Введите значение">
                    <input v-model="weight" placeholder="Введите значение">
                    <input v-model="volume" placeholder="Введите значение">
                    <select v-model="type">
                        <option>truck</option>
                        <option>train</option>
                        <option>ship</option>
